...
app.get('/slack/install', async (req, res) => {
    ...
    res.redirect('https://slack.com/oauth/v2/authorize?client_id=3692654791172.3768860828899&scope=users:read,team:read,team.preferences:read&user_scope=&redirect_uri=https://trongtran.herokuapp.com?is_install=1');
});
